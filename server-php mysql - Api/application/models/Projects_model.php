...
class Projects_model extends CI_Model
{
	 ...
	 *
     */
    function get_all_users_projects(){
        $this->db->order_by('id', 'desc');
	...
	/** Get limit users-projects
	 *@param $limit - limit of query , $start - start of db table index to get query
	 *
     */
    function get_limit_users_projects($limit, $start){
		$this->db->order_by('id', 'desc');
        $this->db->limit($limit, $start);
		$this->db->where('users_id', $this->session->userdata('id'));
        $result = $this->db->get('projects')->result_array();
    ...
    /** Count users-projects rows
	 *
     */
	function get_count_users_projects(){
	   $this->db->where('users_id', $this->session->userdata('id'));
       $result = $this->db->from("projects")->count_all_results();
	   $db_error = $this->db->error();
		if (!empty($db_error['code'])){
