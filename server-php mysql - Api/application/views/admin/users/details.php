...
<tr><td>Main Location</td><td><?php
									   $this->CI =& get_instance();
									   $this->CI->load->database();	
									   $this->CI->load->model('Location_model');
									   $dataArr = $this->CI->Location_model->get_location($c['main_location_id']);
									   echo $dataArr['location_name'];?>
									</td></tr>

<tr><td>Main Location</td><td><?php echo $c['main_location']; ?></td></tr>
...
<tr><td>Inventory Status</td><td><?php echo $c['inventory_status']; ?></td></tr>

<tr><td>Visiblity</td><td><?php echo $c['visiblity']; ?></td></tr>
