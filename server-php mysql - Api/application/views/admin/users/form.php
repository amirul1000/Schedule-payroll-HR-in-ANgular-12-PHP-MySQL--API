...
<div class="form-group"> 
          ...
          <div class="col-md-8"> 
           <input type="text" name="Payroll_ID" value="<?php echo ($this->input->post('Payroll_ID') ? $this->input->post('Payroll_ID') : $users['Payroll_ID']); ?>" class="form-control" id="Payroll_ID" /> 
          </div> 
           </div>
<div class="form-group"> 
                                    <label for="Main Location" class="col-md-4 control-label">Main Location</label> 
         <div class="col-md-8"> 
          <?php 
          ...
          ?> 
          <select name="main_location_id"  id="main_location_id"  class="form-control"/> 
            <option value="">--Select--</option> 
            <?php 
             for($i=0;$i<count($dataArr);$i++) 
             {  
            ?> 
            <option value="<?=$dataArr[$i]['id']?>" <?php if($users['main_location_id']==$dataArr[$i]['id']){ echo "selected";} ?>><?=$dataArr[$i]['location_name']?></option> 
            <?php 
             } 
            ?> 
          </select> 
...
<div class="form-group"> 
          <label for="Main Location" class="col-md-4 control-label">Main Location</label> 
          <div class="col-md-8"> 
           <input type="text" name="main_location" value="<?php echo ($this->input->post('main_location') ? $this->input->post('main_location') : $users['main_location']); ?>" class="form-control" id="main_location" /> 
          </div> 
           </div>
<div class="form-group"> 
...
<div class="form-group"> 
          ...
          <div class="col-md-8"> 
           <input type="text" name="gender" value="<?php echo ($this->input->post('gender') ? $this->input->post('gender') : $users['gender']); ?>" class="form-control" id="gender" /> 
          </div> 
           </div>
<div class="form-group"> 
...
<div class="form-group"> 
          <label for="Country" class="col-md-4 control-label">Country</label> 
          <div class="col-md-8"> 
           <input type="text" name="country" value="<?php echo ($this->input->post('country') ? $this->input->post('country') : $users['country']); ?>" class="form-control" id="country" /> 
          </div> 
           </div>
<div class="form-group"> 
...
<div class="form-group"> 
                                        <label for="Inventory Status" class="col-md-4 control-label">Inventory Status</label> 
          <div class="col-md-8"> 
           <?php 
             $enumArr = $this->customlib->getEnumFieldValues('users','inventory_status'); 
           ?> 
           <select name="inventory_status"  id="inventory_status"  class="form-control"/> 
             ...
             <?php 
              ...
              { 
             ?> 
             <option value="<?=$enumArr[$i]?>" <?php if($users['inventory_status']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php 
              } 
             ?> 
           </select> 
...
<div class="form-group"> 
          <label for="Visiblity" class="col-md-4 control-label">Visiblity</label> 
          <div class="col-md-8"> 
           <input type="text" name="visiblity" value="<?php echo ($this->input->post('visiblity') ? $this->input->post('visiblity') : $users['visiblity']); ?>" class="form-control" id="visiblity" /> 
          </div> 
           </div>
<div class="form-group"> 
