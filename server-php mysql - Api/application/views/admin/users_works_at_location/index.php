...
<div>
	<div class="float_left padding_10">
		<a href="<?php echo site_url('admin/users_works_at_location/save'); ?>"
			class="btn btn-success">Add</a>
	</div>
	<div class="float_left padding_10">
		<i class="fa fa-download"></i> Export <select name="xeport_type" class="select"
			onChange="window.location='<?php echo site_url('admin/users_works_at_location/export'); ?>/'+this.value">
	...
	<div  class="float_right padding_10">
		<ul class="left-side-navbar d-flex align-items-center">
			<li class="hide-phone app-search mr-15">
                <?php echo form_open_multipart('admin/users_works_at_location/search/',array("class"=>"form-horizontal")); ?>
...
<td><?php echo $c['location_name']; ?></td>
		...
		<td>
            <a href="<?php echo site_url('admin/users_works_at_location/details/'.$c['id']); ?>"  class="action-icon"> <i class="zmdi zmdi-eye"></i></a>
            <a href="<?php echo site_url('admin/users_works_at_location/save/'.$c['id']); ?>" class="action-icon"> <i class="zmdi zmdi-edit"></i></a>
            <a href="<?php echo site_url('admin/users_works_at_location/remove/'.$c['id']); ?>" onClick="return confirm('Are you sure to delete this item?');" class="action-icon"> <i class="zmdi zmdi-delete"></i></a>
        </td>
    </tr>
	<?php } ?>
</table>
...
<!--No data-->
<?php
	if(count($users_works_at_location)==0){
?>
