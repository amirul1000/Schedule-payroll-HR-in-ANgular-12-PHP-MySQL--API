...
'main_location_id' => html_escape($this->input->post('main_location_id')),
'main_location' => html_escape($this->input->post('main_location')),
...
'inventory_status' => html_escape($this->input->post('inventory_status')),
...
$this->db->or_like('main_location_id', $key, 'both');
$this->db->or_like('main_location', $key, 'both');
...
$this->db->or_like('inventory_status', $key, 'both');
...
$this->db->or_like('status', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","Email","Password","Title","First Name","Last Name","File Picture","Phone No","Dob","Payroll ID","Main Location Id","Main Location","Address","City","State","Zip","Country Id","Created At","Updated At","User Type","Inventory Status","Status"); 
		   fputcsv($file, $header);
